...
// o borrando pacientes agregados por otros (incluido el bridge "Cargar a
// la Tabla" de Lista de Espera). Ahora el listener solo protege las filas
// realmente en edición (ver triggerAutoSave() en js/02); el resto de
